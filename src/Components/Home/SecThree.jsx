...
function SecThree() {
  return (
    <div  className='w-full overflow-hidden px-[10px] sm:px-[80px] py-[20px] sm:py-[80px]'>
        <div>
        <h1 className='font-medium text-[24px]'>Browse By Category</h1>
        </div>
        <div className='grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6  gap-1 md:gap-4 mt-[30px] '>
             <div className=' bg-[#EDEDED] rounded-lg sm:w-[160px] h-[128px] flex flex-col justify-center items-center sm:mx-auto '>
