 ...
 function Navbar() {
   return (
     <div className='flex justify-between items-center w-full   px-4 lg:px-10 xl:px-20 py-5'>
        <h1 className='font-bold text-black text-[12px]  lg:text-[20px] xl:text-[30px] notable'>The Phone Story</h1>
